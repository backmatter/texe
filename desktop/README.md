...
choose its parent directory. Writing preferences disclose editor and typesetting
choices. Build progress has its own page; the transcript opens in a separate
native details window. The fixed reading width stays centred as the app resizes.
