"""Provision narrowly scoped test-driver keyboard consent on a disposable CI Mac."""
import os
import sqlite3
import time
...
with sqlite3.connect(path) as database:
    ...
    for client in ['org.backmatter.texe']:
        for service in ['kTCCServiceAccessibility', 'kTCCServicePostEvent']:
...
print('Configured keyboard input permission for the disposable test app')
