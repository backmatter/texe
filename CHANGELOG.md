...
All notable changes to this project are documented in this file. Release entries
are generated from Conventional Commit subjects; do not edit them by hand.

The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/),
and this project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).

## [0.1.6](https://github.com/backmatter/texe/compare/v0.1.5...v0.1.6) - 2026-09-15

### Added
- *(editor)* Integrate tex-ls alongside LaTeX Workshop ([#26](https://github.com/backmatter/texe/pull/26))

## [0.1.5](https://github.com/backmatter/texe/compare/v0.1.4...v0.1.5) - 2026-09-10

### Fixed
- Simplify installation across supported platforms ([#21](https://github.com/backmatter/texe/pull/21))

## [0.1.4](https://github.com/backmatter/texe/compare/v0.1.3...v0.1.4) - 2026-09-10
